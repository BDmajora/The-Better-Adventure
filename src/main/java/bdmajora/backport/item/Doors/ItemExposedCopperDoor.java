...
public class ItemExposedCopperDoor extends Item {

	public ItemExposedCopperDoor(String name, int id, String texture) {
		super(name, id);
	...
	public boolean onItemUse(ItemStack itemstack, EntityPlayer entityplayer, World world, int blockX, int blockY, int blockZ, Side side, double xPlaced, double yPlaced) {
		...
		Block doorBlockBottom = ModBlocks.exposedCopperDoorBottom;
		Block doorBlockTop = ModBlocks.exposedCopperDoorTop;
