...
public class ItemOxidizedCopperDoor extends Item {

	public ItemOxidizedCopperDoor(String name, int id, String texture) {
		super(name, id);
	...
	public boolean onItemUse(ItemStack itemstack, EntityPlayer entityplayer, World world, int blockX, int blockY, int blockZ, Side side, double xPlaced, double yPlaced) {
		...
		Block doorBlockBottom = ModBlocks.oxidizedCopperDoorBottom;
		Block doorBlockTop = ModBlocks.oxidizedCopperDoorTop;
