...
public class ItemFoodPotatoRaw extends ItemFood {
	private final int cropsId;
	private final String texture;

	public ItemFoodPotatoRaw(String name, int id, int healAmount, int ticksPerHeal, boolean favouriteWolfFood, int maxStackSize, Block cropsBlock, String texture) {
