...
public class ItemFoodTorchFlower extends ItemFoodStackable {
	private int cropsId;

	public ItemFoodTorchFlower(String name, int id, int healAmount, boolean favouriteWolfFood, int maxStackSize, Block cropsBlock) {
