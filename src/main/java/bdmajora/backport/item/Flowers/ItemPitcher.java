...
public class ItemPitcher extends Item {

	private String texture;

	public ItemPitcher(String name, int id, String texture) {
		super(name, id);
...
//
//
//		BlockBuilder peonyBlockBottom = ModBlocks.pitcherPlantBottom;
//		BlockBuilder peonyBlockTop = ModBlocks.pitcherPlantTop;
//
//		if (!peonyBlockBottom.setItemBlock(world, blockX, blockY, blockZ)) {
//			return false;
