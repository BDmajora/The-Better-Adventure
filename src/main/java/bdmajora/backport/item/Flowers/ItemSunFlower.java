...
public class ItemSunFlower extends Item {

	private String texture;

	public ItemSunFlower(String name, int id, String texture) {
		super(name, id);
	...
	public boolean onItemUse(ItemStack itemstack, EntityPlayer entityplayer, World world, int blockX, int blockY, int blockZ, Side side, double xPlaced, double yPlaced) {
		...
		Block peonyBlockBottom = ModBlocks.sunflowerBottom;
		Block peonyBlockTop = ModBlocks.sunflowerTop;
