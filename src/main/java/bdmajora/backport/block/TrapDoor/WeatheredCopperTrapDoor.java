package bdmajora.backport.block.TrapDoor;

import net.minecraft.core.block.BlockTrapDoor;
import net.minecraft.core.block.material.Material;

public class WeatheredCopperTrapDoor extends BlockTrapDoor {
	public WeatheredCopperTrapDoor(String key, int id, Material material) {
