...
public class BlockCropsBeetRoot extends BlockFlower implements IBonemealable {
	...
	public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int x, int y, int z, int meta, TileEntity tileEntity) {
		if (meta < 3) {
			...
			return new ItemStack[]{new ItemStack(ModItems.seedsBeetRoot, 1), new ItemStack(ModItems.foodBeetRoot, 1)};
		}
	}
