...
public class BlockModelCropsBeetRoot<T extends Block> extends BlockModelStandard<T> {
	public final IconCoordinate[] growthStageTextures = new IconCoordinate[]{
		TextureRegistry.getTexture(MOD_ID + ":block/beetroots_stage0"),
		TextureRegistry.getTexture(MOD_ID + ":block/beetroots_stage1"),
		TextureRegistry.getTexture(MOD_ID + ":block/beetroots_stage2"),
		TextureRegistry.getTexture(MOD_ID + ":block/beetroots_stage3")
	};

	public BlockModelCropsBeetRoot(Block block) {
		super(block);
	}
