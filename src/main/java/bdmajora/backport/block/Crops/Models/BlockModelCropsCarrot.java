...
public class BlockModelCropsCarrot<T extends Block> extends BlockModelStandard<T> {
	public final IconCoordinate[] growthStageTextures = new IconCoordinate[]{
		TextureRegistry.getTexture(MOD_ID + ":block/carrots_stage0"),
		TextureRegistry.getTexture(MOD_ID + ":block/carrots_stage1"),
		TextureRegistry.getTexture(MOD_ID + ":block/carrots_stage2"),
		TextureRegistry.getTexture(MOD_ID + ":block/carrots_stage3")
	};
