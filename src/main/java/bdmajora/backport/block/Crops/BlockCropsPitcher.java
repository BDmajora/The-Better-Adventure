...
public class BlockCropsPitcher extends BlockFlower {

	public BlockCropsPitcher(String key, int id) {
		super(key, id);
...
//	}
	...
	public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int x, int y, int z, int meta, TileEntity tileEntity) {
		if (meta < 3) {
			return new ItemStack[]{new ItemStack(ModItems.seedsPitcherPod, 1)};
		} else {
			return new ItemStack[]{new ItemStack(ModItems.seedsPitcherPod, 1), new ItemStack(ModItems.pitcherFlower, 1)};
		}
	}
}
