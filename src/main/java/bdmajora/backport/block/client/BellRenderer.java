...
public class BellRenderer extends TileEntityRenderer<TileEntityBell> {
	...
	@Override
	public void doRender(TileEntityBell bell, double x, double y, double z, float partialTicks) {
		GL11.glPushMatrix();
		GL11.glTranslatef((float)x + 0.5F, (float)y + 0.75F, (float)z + 0.5F);
		float t = bell.getRingingTicks() + partialTicks;
		GL11.glTranslatef(0.0F, 0.1F + MathHelper.sin(t * 0.1F) * 0.01F, 0.0F);

		float f1 = bell.getRingFacing() - bell.getPrevRot();
