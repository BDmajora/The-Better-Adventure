...
import bdmajora.backport.entity.path.BetterSwimWalkPathFinder;
import bdmajora.backport.util.MathUtil;
...
public class EntityDrowned extends EntityZombie implements IPathGetter, ISwiming {
	...
	public String getEntityTexture() {
		return "/assets/backport/textures/entity/drowned/drowned.png";
	}
	...
	public String getLivingSound() {
		return "backport.drowned.drowned_idle";
	}

	@Override
	protected String getHurtSound() {
		if (random.nextBoolean()) {
			return "backport.drowned_hurt_extra";
		}
		return "backport.drowned_hurt";
	}

	@Override
	protected String getDeathSound() {
		return "backport.drowned_death";
	}
